        ...
        <div class="col-md-12 column">
            <nav class="navbar navbar-default" role="navigation">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/">实验平台 - 作业详情</a>
                </div>
            ...
            <a href="/student/homework"><button type="button" class="btn btn-default" >返回</button></a>
            <form class="form-horizontal" role="form" >
                ...
                <div class=\"form-group\">
                    ...
                    <div class=\"col-sm-10\">
                        ...
                        value='$title' autocomplete=\"off\" disabled/>
                    </div>
                </div>
                <div class=\"form-group\">
                    <label for=\"inputPassword3\" class=\"col-sm-2 control-label\">描述</label>
                    <div class=\"col-sm-10\">
                        <textarea name=\"des\" class=\"form-control\" style=\"resize:none\" rows=\"5\" disabled>$des</textarea>
                    </div>
                </div>
