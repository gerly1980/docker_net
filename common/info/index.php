...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            $sql = "SELECT id,username,teacher_id,time,type FROM user where username = '$username' limit 1";
            ...
            if ($result->num_rows > 0) {
                ...
                <div class='form-group'>
                    ...
                    <div class='col-sm-10'>
                        <input type='text' class='form-control'  value='$type'  readonly='readonly' name='type'/>
                    </div>
                </div>
                <div class='form-group'>
